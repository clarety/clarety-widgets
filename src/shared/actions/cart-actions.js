...
export const addItem = ({ offerId, offerUid, offerPaymentUid, productId, type, quantity, price, panel, options, description, rgUpsellOriginalAmount }) => ({
  type: types.addItem,
  item: {
    offerId: offerId,
    offerUid: offerUid,
    ...
    rgUpsellOriginalAmount: rgUpsellOriginalAmount,
